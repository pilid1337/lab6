class Program
{
    static void Main(string[] args)
    {
        ...
        byte kop3 = ReadByte("Введите копейки (0-99): ", 0, 99);
        ...
        byte kopOrig = ReadByte("Копейки оригинала (0-99): ", 0, 99);
        ...
        byte kopSub = ReadByte("Копейки: ", 0, 99);
        ...
        // 3. Тестирование операторов ++ и --
        Console.WriteLine("\n--- Тест унарных операторов ++ и -- ---");
        Console.WriteLine("Введите сумму:");
        uint rubUn = ReadUInt("Рубли: ");
        byte kopUn = ReadByte("Копейки: ", 0, 99);
        ...
        // 4. Тестирование приведения типов
        Console.WriteLine("\n--- Тест приведения типов ---");
        Console.WriteLine("Введите сумму:");
        uint rubCast = ReadUInt("Рубли: ");
        byte kopCast = ReadByte("Копейки: ", 0, 99);
        ...
        byte kopLeft = ReadByte("Копейки: ", 0, 99);
        ...
        byte kopRight = ReadByte("Копейки: ", 0, 99);
