...
Класс - посетитель бара с полями "счастлив" и "трезв". Дочерний класс - вип-посетитель с доволнительным полем-счётчиком дней до конца подписки. 
...
Переводим всё в копейки, вычитаем нужное кол-во, проверяем число на положительное.
...
Унарные операции: переводим всё в копейки, добавляем/вычитаем 1.
Бинарные операции: переводим всё в копейки, вычитаем, проверяем на положительное.
